    ...
    <div className="min-h-screen pt-28 pb-20 px-8 bg-minfi-blue text-white overflow-hidden">
      <div className="max-w-[1600px] mx-auto space-y-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 py-10 border-b border-white/5">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl font-heading font-black italic tracking-tighter uppercase leading-none">
              Catalogue{" "}
              <span className="text-minfi-emerald">Professionnel</span>
            </h1>
            <p className="text-white/30 text-sm font-medium italic lowercase">
              Développez vos compétences souveraines et validez vos acquis
              ministériels.
            </p>
          </div>
            ...
            <div className="p-1.5 bg-white/5 rounded-2xl border border-white/5 flex">
              {["Tous", "En cours", "Terminés"].map((item) => (
                <button
                  ...
                  className={`px-6 py-2 rounded-xl text-[9px] font-black tracking-widest uppercase transition-all ${
                    filter === item
                      ? "bg-minfi-emerald text-white shadow-xl"
            ...
            >
              ...
              <div className="w-full lg:w-48 aspect-video rounded-2xl bg-neutral-900 shrink-0 relative overflow-hidden group-hover:scale-105 transition-transform duration-500">
                <img
                  src={training.image}
                  alt={training.title}
                  className="w-full h-full object-cover opacity-40 grayscale group-hover:grayscale-0 group-hover:opacity-100 transition-all"
                />
              ...
              <div className="flex-1 space-y-4">
                <div className="flex items-center space-x-4">
                  <span
                    className={`px-2 py-0.5 rounded-md text-[8px] font-black tracking-widest uppercase ${
                      training.category === "Fiscalité"
                        ? "bg-minfi-emerald/10 text-minfi-emerald"
                        : "bg-minfi-gold/10 text-minfi-gold"
                    }`}
                  >
                    {training.category}
                  </span>
                ...
                <div className="space-y-1">
                  <h3 className="text-2xl font-heading font-black italic tracking-tight group-hover:text-minfi-emerald transition-colors">
                    {training.title}
                  </h3>
                  <p className="text-white/40 text-xs leading-relaxed max-w-2xl font-medium">
              ...
              <div className="w-full lg:w-72 space-y-4 pt-6 lg:pt-0 lg:pl-8 lg:border-l border-white/5">
                ...
                <a
                  href="https://campus.studieslearning.com/course/view.php?id=1526"
                  target="_blank"
        ...
        <div className="pt-20 text-center space-y-6">
          ...
          <button className="px-10 py-4 border border-white/5 text-white/40 rounded-2xl text-[9px] font-black tracking-widest uppercase hover:bg-white/5 hover:text-white transition-all">
            Support Technique Agent
          </button>
        </div>
      </div>
    </div>
