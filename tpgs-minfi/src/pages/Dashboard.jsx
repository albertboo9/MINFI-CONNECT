...
import {
    ...
    Target, Zap, Bell, FileText, Plus, Search, HelpCircle
} from 'lucide-react';
...
const DASHBOARD_ALERTS = [
    { id: 'da1', type: 'critical', msg: 'Budget DR des Douanes épuisé à 102%', date: 'Il y a 10m' },
    { id: 'da2', type: 'warning', msg: '12 évaluations annuelles en retard (DSI)', date: 'Il y a 1h' },
    { id: 'da3', type: 'info', msg: 'Nouvelle formation "Cyber-sécurité" disponible', date: 'Aujourd\'hui' },
];
    ...
    return (
        <div className="space-y-8 pb-10">
            ...
            <section className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="animate-slide-up">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-xs font-mono" style={{ color: 'var(--text-faint)' }}>v0.8.4-interactive</span>
                    </div>
                    ...
                    <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>
                        Voici un aperçu de l'activité du système aujourd'hui.
                    </p>
                </div>
                ...
                <div className="flex gap-2">
                    ...
                    <button onClick={() => handleQuickAction('Settings')} className="btn-ghost text-xs">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {(activeRole === ROLES.MANAGER || activeRole === ROLES.HRM) && (
                    <>
                ...
                {activeRole === ROLES.TECH && (
                    <>
                        <StatCard label="Serveurs LMS" value="En ligne" icon={Zap} color="emerald" />
                        <StatCard label="Utilisateurs actifs" value="452" trend={14} icon={Users} color="blue" />
                        <StatCard label="Taux d'erreur API" value="0.02%" trend={-40} icon={AlertTriangle} color="emerald" />
                ...
                <div className="space-y-6">
                    ...
                    <div className="card overflow-hidden">
                        <div className="p-4 border-b flex items-center justify-between" style={{ borderColor: 'var(--border)' }}>
                            <h3 className="section-label">Alertes Critiques</h3>
                    ...
                    {/* Recent Activity */}
                    <div className="card p-6">
                        <h3 className="section-label mb-6">Activité Récente</h3>
                    ...
                    {/* Productivity Widget */}
                    <div className="card p-5 bg-gradient-to-br from-tpgs-emerald/10 to-blue-400/5 border-tpgs-emerald/20">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-8 h-8 rounded-lg bg-tpgs-emerald flex items-center justify-center text-white">
                                <TrendingUp size={16} />
                            </div>
                            <h4 className="text-sm font-bold" style={{ color: 'var(--text-primary)' }}>Objectif Trimestriel</h4>
                        </div>
                        <div className="space-y-3">
                            <div className="flex justify-between text-[10px] font-bold">
                                <span style={{ color: 'var(--text-muted)' }}>Taux de réalisation</span>
                                <span className="text-tpgs-emerald">75%</span>
                            </div>
                            <div className="progress-bar h-1.5">
                                <motion.div initial={{ width: 0 }} animate={{ width: '75%' }} transition={{ duration: 1 }} className="progress-fill" />
                            </div>
                            <p className="text-[10px] italic leading-relaxed" style={{ color: 'var(--text-muted)' }}>
                                "Vous êtes en avance de 2 jours sur le planning de formation."
                            </p>
                        </div>
                    </div>
                </div>
