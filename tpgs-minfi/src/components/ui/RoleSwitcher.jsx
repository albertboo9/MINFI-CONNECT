...
const ROLE_OPTIONS = [
  ...
  { role: ROLES.PROVIDER, label: "Prestataire", color: "pink" },
...
const colorMap = {
  emerald: {
    dot: "bg-tpgs-emerald",
    border: "border-tpgs-emerald/30",
    bg: "bg-tpgs-emerald/10 hover:bg-tpgs-emerald/20",
  },
  blue: {
    dot: "bg-tpgs-blue",
    border: "border-tpgs-blue/30",
    bg: "bg-tpgs-blue/10 hover:bg-tpgs-blue/20",
  },
  gold: {
    dot: "bg-tpgs-gold",
    border: "border-tpgs-gold/30",
    bg: "bg-tpgs-gold/10 hover:bg-tpgs-gold/20",
  },
  cyan: {
    dot: "bg-tpgs-cyan",
    border: "border-tpgs-cyan/30",
    bg: "bg-tpgs-cyan/10 hover:bg-tpgs-cyan/20",
  },
  red: {
    dot: "bg-red-400",
  ...
  purple: {
    dot: "bg-tpgs-purple",
    border: "border-tpgs-purple/30",
    bg: "bg-tpgs-purple/10 hover:bg-tpgs-purple/20",
  },
  pink: {
    dot: "bg-pink-400",
...
export default function RoleSwitcher() {
  ...
  return (
    <div className="relative mb-1">
      ...
      >
        <div
          className={clsx("w-2 h-2 rounded-full flex-shrink-0", colors.dot)}
        />
            ...
            return (
              <button
                ...
                className={clsx(
                  ...
                  isActive
                    ? clsx(c.bg, "text-white")
                    : "hover:bg-tpgs-hover text-slate-300",
                )}
              >
                <div
                  className={clsx("w-2 h-2 rounded-full flex-shrink-0", c.dot)}
                />
